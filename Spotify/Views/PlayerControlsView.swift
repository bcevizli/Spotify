...
//  Spotify
//
//  Created by Adem Burak Cevizli on 2.03.2023.
//

import Foundation
import UIKit

protocol PlayerConrolsViewDelegate: AnyObject {
    func playerControlsViewDidTapPlayPauseButton(_ playerControlsView: PlayerControlsView)
    func playerControlsViewDidTapForwardButton(_ playerControlsView: PlayerControlsView)
    func playerControlsViewDidTapBacwardsButton(_ playerControlsView: PlayerControlsView)
...
final class PlayerControlsView: UIView {
    ...
    weak var delegate: PlayerConrolsViewDelegate?
    ...
    @objc private func didTapBack() {
        delegate?.playerControlsViewDidTapBacwardsButton(self)
    }
