...
class PlaylistViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        APICaller.shared.getPlayistDetails(for: playlist) { [weak self] result in
...
extension PlaylistViewController: PlaylistHeaderCollectionReusableViewDelegate {
    func PlaylistHeaderCollectionReusableViewDidPlayAll(_ header: PlaylistHeaderCollectionReusableView) {
